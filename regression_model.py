...
from model.data_utils import minibatches, pad_sequences, \
        ...
        get_mean_NDCG, softmax, sort_xgb_predictions
...
class NERModel(BaseModel):
    ...
    def add_logits_op(self):
        ...
        with tf.variable_scope("proj"):
            ...
            #self.logits = tf.reduce_mean(tf.log_sigmoid(logits), axis=0)
            
            #self.logits = tf.reduce_mean(tf.log_sigmoid(logits), axis=1)
