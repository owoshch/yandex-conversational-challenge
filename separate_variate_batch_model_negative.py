...
class NERModel(BaseModel):
    ...
    def run_evaluate(self, test, path_to_test=None):
        ...
        print ('my preds', predicted_labels[50:55])
        print ('test preds', [x[2] for x in test[50:55]])
        sorted_preds = sort_xgb_predictions(test_dataframe, 3 - np.array(predicted_labels))
